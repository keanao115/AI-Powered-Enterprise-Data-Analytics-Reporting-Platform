        ...
        for i in range(1, count + 1):
            ...
            if is_unhappy:
                ...
                status = random.choice(
                    ["Active - At Risk", "Active - At Risk", "Under Review", "Churned"]
                )
            else:
            ...
            writer.writerow(
                [
                    ...
                    depth,
                    last_login,
                    "Yes" if sponsor_engaged else "No",
                    risk_score,
                    risk_level,
                    status,
                ]
    ...
    with open(filepath, "w", newline="", encoding="utf-8") as f:
        ...
        for i in range(1, count + 1):
            ...
            if status_rand < 0.12:
                ...
                stock_status = (
                    "Critical Shortage" if current_stock < (safety_stock * 0.4) else "Low Stock"
                )
...
def generate_employee_performance(count=1500):
    ...
    headers = [
        ...
        "base_salary_usd",
        "bonus_target_pct",
        "annual_total_comp_usd",
        "performance_rating",
        "last_review_score",
        "projects_completed_ytd",
        "training_hours_completed",
        "overtime_hours_per_month",
        "satisfaction_score",
        "work_life_balance_rating",
        "peer_recognition_count",
        "attrition_risk_pct",
...
def generate_marketing_campaigns(count=1200):
    ...
    audiences = [
        "Fortune 500 CTOs & VP Infrastructure",
        "FinTech Chief Information Security Officers (CISO)",
        "Enterprise Data Engineering Leads",
        "Cloud Native DevOps & SRE Architects",
        "Healthcare & Life Sciences Tech Leads",
        "Retail E-Commerce Engineering Directors",
        "Global AI/ML Research Scientists",
        "SMB Growth Tech Founders",
    ]

    regions = [
        "North America",
        "Western Europe",
        "APAC (Japan/Taiwan/SG)",
        "ANZ",
        "Global Multi-Region",
        "Latin America",
        "Middle East",
    ...
    headers = [
        ...
        "cost_per_lead_usd",
        "mql_qualified_leads",
        "sql_sales_opportunities",
        "pipeline_created_usd",
        "conversions",
    ...
    campaign_themes = [
        "Next-Gen Lakehouse Migration",
        "GenAI Enterprise Copilot Accelerator",
        "Zero-Trust Perimeter Defense",
        "Cloud Cost Optimization 40%",
        "Kubernetes Multi-Cloud Mesh",
        "Real-Time Telemetry at Scale",
        "Automated Compliance & SOC2",
        "Edge AI for Smart Robotics",
        "Quantum-Safe Cryptography Suite",
        "Developer Productivity Blitz",
        "High-Throughput Streaming Engine",
        "Unified Customer 360 AI",
    ]
    ...
    with open(filepath, "w", newline="", encoding="utf-8") as f:
        ...
        for i in range(1, count + 1):
            ...
            status = (
                "Completed"
                if c_end < datetime(2026, 8, 1)
                else ("Active" if c_start <= datetime(2026, 8, 15) else "Scheduled")
            )
