            ...
            "olist_orders": {
                ...
                "columns": {
                    ...
                    "order_status": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Order lifecycle status (delivered, shipped, canceled)",
                    },
                    "order_purchase_timestamp": {
                        "type": "TIMESTAMP",
                        "classification": DataClassification.PUBLIC,
                        "description": "Purchase transaction timestamp",
                    },
                    "order_approved_at": {
                        "type": "TIMESTAMP",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "order_delivered_carrier_date": {
                        "type": "TIMESTAMP",
                        "classification": DataClassification.PUBLIC,
                        "description": "Hand-off to logistics carrier",
                    },
                    ...
                    "order_estimated_delivery_date": {
                        "type": "TIMESTAMP",
                        "classification": DataClassification.PUBLIC,
                        "description": "Estimated promised delivery date",
                    },
                    "is_late_delivery": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "1 if actual delivery date exceeded estimated date, else 0",
                    },
                    "delivery_delay_days": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Number of days delivered past estimate",
                    },
                    "order_year": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Order fiscal year",
                    },
                    "order_month": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Order fiscal month (1-12)",
                    },
                    "order_year_month": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
            ...
            "olist_order_items": {
                ...
                "columns": {
                    "order_id": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Foreign key to olist_orders",
                    },
                    "order_item_id": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Item sequential index within order",
                    },
                    "product_id": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Foreign key to olist_products",
                    },
                    "seller_id": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "freight_value": {
                        "type": "DECIMAL(10,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Freight and shipping charge in BRL",
                    },
                    "total_item_value": {
                        "type": "DECIMAL(10,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Sum of price and freight",
                    },
                },
            },
            "olist_products": {
                ...
                "columns": {
                    ...
                    "product_weight_g": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Product physical weight in grams",
                    },
                    "product_length_cm": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
            ...
            "olist_customers": {
                ...
                "columns": {
                    "customer_id": {
                        "type": "VARCHAR",
                        "classification": DataClassification.CONFIDENTIAL,
                        "description": "Order-specific customer key",
                    },
                    "customer_unique_id": {
                        "type": "VARCHAR",
                        "classification": DataClassification.CONFIDENTIAL,
                        "description": "Unique customer master identifier",
                    },
                    ...
                    "customer_state": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "2-letter Brazilian state code (e.g. SP, RJ, MG)",
                    },
                },
            },
            ...
            "olist_order_reviews": {
                ...
                "columns": {
                    ...
                    "review_score": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Customer satisfaction rating (1 to 5 stars)",
                    },
            ...
            "nyc_taxi_trips": {
                ...
                "columns": {
                    ...
                    "pickup_location_id": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "TLC taxi pickup zone location ID",
                    },
                    "dropoff_location_id": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "TLC taxi dropoff zone location ID",
                    },
                    "rate_code_id": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "payment_type": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Payment method (Credit Card, Cash, Dispute)",
                    },
                    "fare_amount": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "extra_surcharge": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Rush hour / overnight surcharges",
                    },
                    "mta_tax": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "MTA tax ($0.50)",
                    },
                    "tip_amount": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Driver tip amount",
                    },
                    "tolls_amount": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Bridge and tunnel tolls",
                    },
                    ...
                    "pickup_hour": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Pickup hour of the day (0-23)",
                    },
                    "pickup_day_of_week": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
            ...
            "taxi_zones": {
                ...
                "columns": {
                    "location_id": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Location ID matching pickup/dropoff ID",
                    },
                    "zone_name": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Neighborhood zone name (e.g. Midtown Center, JFK Airport)",
                    },
                    "borough": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
            ...
            "bts_flights": {
                ...
                "columns": {
                    "flight_id": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Unique flight record key",
                    },
                    "flight_date": {
                        "type": "DATE",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "carrier_code": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "2-letter IATA carrier code (e.g. AA, DL, UA, WN)",
                    },
                    "flight_number": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "origin_airport": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Origin 3-letter IATA airport code",
                    },
                    "dest_airport": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "route": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Origin-Destination route pair (e.g. JFK-LAX)",
                    },
                    "scheduled_dep_time": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Scheduled departure time (HH:MM)",
                    },
                    "departure_delay_minutes": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Departure delay in minutes (>14 min considered delayed)",
                    },
                    "arrival_delay_minutes": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Arrival delay in minutes (>14 min considered delayed)",
                    },
                    "is_arr_on_time": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "1 if arrived <= 14 mins of schedule and not canceled, else 0",
                    },
                    "is_dep_on_time": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "1 if departed <= 14 mins of schedule and not canceled, else 0",
                    },
                    "cancelled": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "1 if flight was cancelled, else 0",
                    },
                    "cancellation_reason": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Cancellation cause (Weather, Carrier, NAS, Security)",
                    },
                    "diverted": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "1 if flight was diverted to alternate airport, else 0",
                    },
                    "air_time_minutes": {
                        "type": "DECIMAL(8,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Flight airborne duration in minutes",
                    },
                    "distance_miles": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "taxi_out_minutes": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Taxi-out duration from gate to takeoff",
                    },
                    "taxi_in_minutes": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Taxi-in duration from landing to gate",
                    },
                    "carrier_delay_minutes": {
                        "type": "DECIMAL(8,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Delay attributable to airline operations",
                    },
                    "weather_delay_minutes": {
                        "type": "DECIMAL(8,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Delay attributable to meteorological conditions",
                    },
                    "nas_delay_minutes": {
                        "type": "DECIMAL(8,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Delay attributable to National Airspace System",
                    },
                    "security_delay_minutes": {
                        "type": "DECIMAL(8,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Delay attributable to security screening",
                    },
                    "late_aircraft_delay_minutes": {
                        "type": "DECIMAL(8,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Delay caused by late arrival of previous aircraft",
                    },
                    "month": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
            ...
            "bts_airlines": {
                ...
                "columns": {
                    ...
                    "airline_name": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Full legal carrier name",
                    },
                    "headquarters": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Corporate headquarters city/state",
                    },
                },
            },
            "bts_airports": {
                ...
                "columns": {
                    ...
                    "region": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "U.S. geographic region (Northeast, South, Midwest, West)",
                    },
                },
            },
            ...
            "mimic_patients": {
                ...
                "columns": {
                    "subject_id": {
                        ...
                        "description": "Deidentified patient ID",
                    },
                    "gender": {
                        "type": "VARCHAR",
                        "classification": DataClassification.CONFIDENTIAL,
                    ...
                    "anchor_age": {
                        "type": "INTEGER",
                        "classification": DataClassification.CONFIDENTIAL,
                        "description": "Patient anchor age in years",
                    },
                    "anchor_year_group": {
                        "type": "VARCHAR",
                        "classification": DataClassification.RESTRICTED,
                        "description": "Deidentified 3-year date shift group",
                    },
                    "dod_recorded": {
                        "type": "INTEGER",
                        "classification": DataClassification.RESTRICTED,
                        "description": "Date of death recorded flag",
                    },
                },
            },
            "mimic_admissions": {
                ...
                "columns": {
                    ...
                    "admission_type": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Admission category (EW EMER., OBSERVATION, URGENT)",
                    },
                    "admission_location": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Point of origin location",
                    },
                    "insurance": {
                        "type": "VARCHAR",
                        "classification": DataClassification.CONFIDENTIAL,
                    ...
                    "hospital_expire_flag": {
                        "type": "INTEGER",
                        "classification": DataClassification.RESTRICTED,
                        "description": "1 if deceased during admission, else 0",
                    },
                    "length_of_stay_days": {
                        "type": "DECIMAL(8,1)",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "admission_month": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Admission month (1-12)",
                    },
                },
            },
            "mimic_icu_stays": {
                ...
                "columns": {
                    ...
                    "first_careunit": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "First ICU care unit entered",
                    },
                    "last_careunit": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Final ICU care unit before discharge",
                    },
                    "icu_los_days": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Length of stay in ICU in days",
                    },
                    "intime": {
                        "type": "TIMESTAMP",
                        "classification": DataClassification.RESTRICTED,
            ...
            "mimic_diagnoses": {
                ...
                "columns": {
                    ...
                    "seq_num": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Diagnosis priority sequence (1=Primary)",
                    },
                    "icd_code": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "ICD-10 clinical diagnosis code",
                    },
                    "icd_title": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Standardized medical diagnosis title",
                    },
                    "category": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Clinical system category (Circulatory, Respiratory, Endocrine)",
                    },
                },
            },
            ...
            "chicago_crimes": {
                ...
                "columns": {
                    "case_number": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "CPD official case number",
                    },
                    "incident_date": {
                        "type": "TIMESTAMP",
                        "classification": DataClassification.PUBLIC,
                        "description": "Reported incident timestamp",
                    },
                    "primary_type": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Primary crime type (THEFT, BATTERY, ASSAULT, etc.)",
                    },
                    "crime_category": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "High-level classification (Property, Violent, Financial)",
                    },
                    "description": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Subcategory incident description",
                    },
                    "location_description": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Location setting (STREET, RESIDENCE, APARTMENT)",
                    },
                    "arrest": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "1 if arrest was made, else 0",
                    },
                    "domestic": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "1 if domestic-related, else 0",
                    },
                    "district": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "CPD Police District Number (1-25)",
                    },
                    "ward": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Chicago City Council Ward (1-50)",
                    },
                    "community_area": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Chicago community area index (1-77)",
                    },
                    "fbi_code": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "FBI UCR classification code",
                    },
                    "year": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Calendar year of incident",
                    },
                    "month": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
            ...
            "chicago_districts": {
                ...
                "columns": {
                    ...
                    "district_name": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "District name (e.g. Central, Near North, Harrison)",
                    },
                    "station_address": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "District station street address",
                    },
                },
            },
            ...
            "market_securities": {
                ...
                "columns": {
                    ...
                    "sector": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "GICS economic sector",
                    },
                    "industry": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "exchange": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Listing exchange (NASDAQ, NYSE)",
                    },
                    "cik": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
            ...
            "market_daily_prices": {
                ...
                "columns": {
                    ...
                    "volume": {
                        "type": "BIGINT",
                        "classification": DataClassification.PUBLIC,
                        "description": "Shares traded volume",
                    },
                    "daily_return_pct": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "trading_value_usd": {
                        "type": "DECIMAL(14,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Total dollar trading volume",
                    },
                    "ma_50": {
                        "type": "DECIMAL(10,2)",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "volatility_30d": {
                        "type": "DECIMAL(8,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "30-day realized price volatility",
                    },
                    "year_month": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
            ...
            "market_financial_facts": {
                ...
                "columns": {
                    "fact_id": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Unique financial fact identifier",
                    },
                    "ticker": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "fiscal_period": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "Fiscal quarter (e.g. 2023-Q1, 2024-Q2)",
                    },
                    "form_type": {
                        "type": "VARCHAR",
                        "classification": DataClassification.PUBLIC,
                        "description": "SEC filing form (10-Q, 10-K)",
                    },
                    "revenue_mil_usd": {
                        "type": "DECIMAL(10,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Reported total revenue in millions USD",
                    },
                    "net_income_mil_usd": {
                        "type": "DECIMAL(10,1)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Reported net income in millions USD",
                    },
                    "free_cash_flow_mil_usd": {
                        "type": "DECIMAL(10,1)",
                        "classification": DataClassification.PUBLIC,
                    ...
                    "filing_date": {
                        "type": "DATE",
                        "classification": DataClassification.PUBLIC,
                        "description": "SEC EDGAR official filing date",
                    },
                },
            },
            ...
            "customer_churn": {
                ...
                "columns": {
                    ...
                    "churn_risk_score": {
                        "type": "DECIMAL(4,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "ML churn risk score (0.0 to 1.0)",
                    },
                },
            },
            "inventory_supply_chain": {
                ...
                "columns": {
                    ...
                    "safety_stock": {
                        "type": "INTEGER",
                        "classification": DataClassification.PUBLIC,
                        "description": "Minimum safety buffer",
                    },
                },
            },
            "financial_metrics": {
            ...
            "employee_performance": {
                ...
                "columns": {
                    ...
                    "performance_rating": {
                        "type": "DECIMAL(3,2)",
                        "classification": DataClassification.PUBLIC,
                        "description": "Performance rating (1.0 to 5.0)",
                    },
