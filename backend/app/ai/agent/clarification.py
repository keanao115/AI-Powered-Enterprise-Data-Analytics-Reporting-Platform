...
class AmbiguityDetector:
    ...
    AMBIGUOUS_PATTERNS = {
        "sales": (
            "metric",
            [
                "Revenue (Sum of Completed Order Amount)",
        ...
        "performance": (
            "dimension",
            ["Sales Team Revenue Growth", "Regional Return Rate", "Employee Sales Targets"],
        ),
        "revenue": (
            "time_period",
            ["Current Month vs Last Month", "Year-to-Date (YTD)", "Last 30 Days"],
        ),
    }
